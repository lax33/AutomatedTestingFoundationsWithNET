...
namespace ManagesCarPark
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PassengerCar passengerCarFord = new PassengerCar("Ford", CarType.passengerCar, "red",
                 "1969", "7897456621", engineFord, transmissionFord, chassisFord);
            ...
            Truck truckRenault = new Truck("Renault", CarType.truck, "blue", "2012", "545624886",
            ...
            Bus busNissan = new Bus("Nissan", CarType.bus,
                "Yellow", "2006", "8787951545", "30", engineNissan, transmissionNissan, chassisBus);
            ...
            Chassis chassisScuter = new Chassis(2, "----", 150);
